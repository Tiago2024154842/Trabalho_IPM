...
export function CartaoPasso({ instrucao, imagem, emFoco, onClick, animacao, totalCartoes }) {
  return (
    <button
      ...
      className={cn(
        'group relative flex flex-col items-center gap-2 rounded-2xl bg-white px-3 py-4 transition-all duration-300',
        'border-[4px] focus:outline-none w-52 md:w-60 shrink-0',
        emFoco
    ...
    >
      ...
      <div className="flex h-44 w-full items-center justify-center rounded-xl bg-[#F5F5F5] p-3 md:h-48 shrink-0">
        <Image
          src={imagem}
          alt={instrucao}
          width={160}
